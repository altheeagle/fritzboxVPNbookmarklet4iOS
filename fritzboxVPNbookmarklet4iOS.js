	...
	if (userseite){
		...
		xhr.onreadystatechange = function() {
	        if (xhr.readyState>3 && xhr.status==200) {
				...
				xmlString = xmlString.replace(/#XAuthPassword#/g,"nixgibts");
